  ...
  return (function (e) {
    ...
    window.webpackJsonpjwplayer = function (i, o) {
      for (var a, s, l = 0, c = []; l < i.length; l++)
        (s = i[l]), r[s] && c.push.apply(c, r[s]), (r[s] = 0);
      for (a in o) e[a] = o[a];
        ...
        (r = function () {
          ...
          (w.reduce =
            ...
            w.inject =
              function (e, t, n, i) {
                ...
                if ((null == e && (e = []), c && e.reduce === c))
                  return (
                    i && (t = w.bind(t, i)), r ? e.reduce(t, n) : e.reduce(t)
                  );
                if (
                  (y(e, function (e, o, a) {
          ...
          (w.contains = w.include =
            function (e, t) {
              return null == e
                ? !1
                : (e.length !== +e.length && (e = w.values(e)),
                  w.indexOf(e, t) >= 0);
            }),
          ...
          (w.bind = function (e, t) {
            ...
            (w.defaults = function (e) {
              return (
                y(r.call(arguments, 1), function (t) {
        ...
        (r = function (e, t, n, i, r, o, a, s, l, c, u) {
          ...
          return (
            ...
            (d.foreach = function (e, t) {
              var n, i;
              for (n in e)
                "function" === d.typeOf(e.hasOwnProperty)
          ...
          var t = [],
            ...
            i = {
              ...
              off: function (t, n, i) {
                ...
                for (
                  l = t ? [t] : e.keys(this._events), c = 0, u = l.length;
                  u > c;
                  c++
                )
                  if (((t = l[c]), (s = this._events[t]))) {
                    if (((this._events[t] = r = []), n || i))
                      for (d = 0, p = s.length; p > d; d++)
                        (a = s[d]),
                          ((n &&
                            n !== a.callback &&
                            n !== a.callback._callback) ||
                            (i && i !== a.context)) &&
                            r.push(a);
      ...
      (i = [n(3), n(4), n(1), n(2)]),
        (r = function (e, t, n, i) {
          ...
          var l = !n.isUndefined(window.PointerEvent),
            ...
            p = function (e, i) {
              function c(e) {
                (u || (l && "touch" !== e.pointerType)) &&
                  v(t.touchEvents.OVER, e);
              }
              function p(e) {
                (u || (l && "touch" !== e.pointerType)) &&
                  v(t.touchEvents.MOVE, e);
              }
              function f(n) {
                (u ||
                  (l &&
                    "touch" !== n.pointerType &&
                    !e.contains(document.elementFromPoint(n.x, n.y)))) &&
                  v(t.touchEvents.OUT, n);
              }
              function h(t) {
                (w = t.target),
                  (E = r(t, "X")),
              ...
              function g(e) {
                ...
                if (b) v(n.DRAG, e);
                  ...
                  var a = r(e, "X"),
                    ...
                    u = l - k;
                  c * c + u * u > o * o &&
                    (v(n.DRAG_START, e), (b = !0), v(n.DRAG, e));
                }
              ...
              function m(n) {
                var r = t.touchEvents;
                l
                  ? (i.preventScrolling && e.releasePointerCapture(y),
                  ...
                  b
                    ? v(r.DRAG_END, n)
                    : (i.directSelect && n.target !== e) ||
                      -1 !== n.type.indexOf("cancel") ||
                      (l && n instanceof window.PointerEvent
                        ? "touch" === n.pointerType
                          ? v(r.TAP, n)
                          : v(r.CLICK, n)
                        : u
              ...
              function v(e, r) {
                ...
                if (
                  i.enableDoubleTap &&
                  (e === t.touchEvents.CLICK || e === t.touchEvents.TAP)
                )
                  if (n.now() - A < L) {
                    var s =
                      e === t.touchEvents.CLICK
                        ? t.touchEvents.DOUBLE_CLICK
                        : t.touchEvents.DOUBLE_TAP;
              ...
              (i = i || {}),
                l
                  ? (e.addEventListener("pointerdown", h),
                    i.useHover &&
                      (e.addEventListener("pointerover", c),
                      e.addEventListener("pointerout", f)),
                    i.useMove && e.addEventListener("pointermove", p))
                  : u &&
                ...
                (this.destroy = function () {
                  e.removeEventListener("touchstart", h),
                    ...
                    l &&
                      ...
                      e.removeEventListener("pointerdown", h),
                      e.removeEventListener("pointermove", g),
                      e.removeEventListener("pointermove", p),
                      e.removeEventListener("pointercancel", m),
                      e.removeEventListener("pointerout", f),
                      e.removeEventListener("pointerup", m)),
            ...
            s = function (t) {
              ...
              return (
                "s" === t.slice(-1)
                  ...
                  ? (i = 3600 * parseFloat(t))
                  : n.length > 1
                  ? ((i = parseFloat(n[n.length - 1])),
                    (i += 60 * parseFloat(n[n.length - 2])),
                    3 === n.length && (i += 3600 * parseFloat(n[n.length - 3])))
                  : (i = parseFloat(t)),
                i
              );
            },
    ...
    function (e, t, n) {
      var i, r;
      (i = [n(2), n(1), n(4), n(6), n(285), n(31), n(3)]),
            ...
            t.extend(this, a, {
              ...
              load: function (e) {
                (j = e),
                  ...
                  R("load", e),
                  e.sources.length &&
                    "hls" !== e.sources[0].type &&
                    this.sendMediaType(e.sources);
              },
              play: function () {
                R("play");
              },
              ...
              getSwfObject: function (e) {
                ...
                return t
                  ? (t.off(null, null, this), t)
                  : r.embed(u.flashplayer, e, s(c), u.wmode);
              },
                  ...
                  (v = r),
                    ...
                    w.once(
                      ...
                      function () {
                        ...
                        i === w
                          ? (w.__ready = !0)
                          : this.trigger(n.JWPLAYER_MEDIA_ERROR, i),
                          j && R("init", j);
                      },
                      this
                    );
                  var o = [
                      n.JWPLAYER_MEDIA_META,
                      n.JWPLAYER_MEDIA_ERROR,
                      n.JWPLAYER_MEDIA_SEEK,
                      n.JWPLAYER_MEDIA_SEEKED,
                      "subtitlesTracks",
    ...
    function (e, t, n) {
      var i, r;
      (i = [n(45), n(2), n(130), n(1), n(4), n(6), n(31), n(3)]),
        (r = function (e, t, n, i, r, o, a, s) {
          ...
          function f(f, A) {
              ...
              h(Re),
                ...
                Me &&
                  (xe.state === o.STALLED
                    ...
                    : xe.state === o.PLAYING && (Re = setTimeout(ne, g)),
                  (Oe && Ge.duration === 1 / 0 && 0 === Ge.currentTime) ||
                    (O(S()),
                    M(Ge.currentTime),
                    I(ie(), Ae, ke),
                    xe.state === o.PLAYING &&
                      (xe.trigger(r.JWPLAYER_MEDIA_TIME, {
                        position: Ae,
                        duration: ke,
                      }),
                      R())));
            ...
            function N() {
              Me &&
                (Ge.muted && ((Ge.muted = !1), (Ge.muted = !0)),
            ...
            function F() {
              xe.setState(o.PLAYING),
                Ge.hasAttribute("jw-played") ||
                  Ge.setAttribute("jw-played", ""),
                xe.trigger(r.JWPLAYER_PROVIDER_FIRST_FRAME, {});
            }
            function J() {
              xe.state !== o.COMPLETE &&
                Ge.currentTime !== Ge.duration &&
                xe.setState(o.PAUSED);
            }
            function V() {
              Oe ||
                Ge.paused ||
                ...
                (xe.state !== o.LOADING &&
                  xe.state !== o.ERROR &&
                  (xe.seeking || xe.setState(o.STALLED)));
            }
            function B() {
              Me &&
                (t.log("Error playing media: %o %s", Ge.error, Ge.src),
            ...
            function H(e) {
              ...
              var t = U(e);
              t &&
                xe.trigger(r.JWPLAYER_MEDIA_LEVELS, {
                  levels: t,
                  currentQuality: Se,
                });
            }
            function z(e) {
              ...
              if (e)
                for (var i = 0; i < e.length; i++)
                  if ((e[i]["default"] && (t = i), n && e[i].label === n))
                    return i;
            ...
            function G(e, n) {
              ...
              r || "none" === a || "started" === a
                ? ((ke = n), K(_e[Se]), q(Ue), Ge.load())
                : (0 === e && Ge.currentTime > 0 && ((Te = -1), xe.seek(e)),
                  Ge.play()),
                (Ae = Ge.currentTime),
                w &&
                  !s &&
            ...
            function K(e) {
              (We = null),
                ...
                (Je = -1),
                (Be = -1),
                He.reason || ((He.reason = "initial choice"), (He.level = {})),
                (Pe = !1),
                (Le = !1),
                (Oe = p(e)),
                e.preload &&
                  e.preload !== Ge.getAttribute("preload") &&
            ...
            function q(e) {
              ...
              !De &&
                i &&
                (e !== Ue || (e.length && !Ge.textTracks.length)) &&
                (be(), n.emptyElement(Ge), (Ue = e), X(e));
            }
            function X(e) {
              if (e)
                for (var n = !1, i = 0; i < e.length; i++) {
                  var r = e[i];
                  if (
                    /\.(?:web)?vtt(?:\?.*)?$/i.test(r.file) &&
                    /subtitles|captions|descriptions|chapters|metadata/i.test(
                      r.kind
                    )
                  ) {
                    n ||
                      (!Ge.hasAttribute("crossorigin") &&
                        t.crossdomain(r.file) &&
                        (Ge.setAttribute("crossorigin", "anonymous"),
                        (n = !0)));
            ...
            function $() {
              for (
                var e = Ge.seekable ? Ge.seekable.length : 0, t = 1 / 0;
                e--;
            ...
            function te() {
              xe.trigger("volume", { volume: Math.round(100 * Ge.volume) }),
                xe.trigger("mute", { mute: Ge.muted });
            }
            function ne() {
              Ge.currentTime === Ae && V();
            }
            function ie() {
              var e = Ge.buffered,
                n = Ge.duration;
              return !e || 0 === e.length || 0 >= n || n === 1 / 0
                ? 0
                : t.between(e.end(e.length - 1) / n, 0, 1);
            }
            function re() {
            ...
            function ue(e) {
              if (e && e.length && Be !== e[0].startTime) {
                var n = t.parseID3(e);
                (Be = e[0].startTime),
                  xe.trigger("meta", { metadataTime: Be, metadata: n });
              }
            }
            function de(e) {
            ...
            function fe(e) {
              if (((Fe = null), e)) {
                ...
                u(e, "change", le),
                  Fe &&
                    xe.trigger("audioTracks", { currentTrack: Ve, tracks: Fe });
              }
            }
            function he(e) {
              Ge &&
                ...
                Fe &&
                e > -1 &&
                e < Ge.audioTracks.length &&
                e !== Ve &&
                ((Ge.audioTracks[Ve].enabled = !1),
                (Ve = e),
            ...
            function ve(e) {
              if (((We = null), e)) {
                if (e.length) {
                  ...
                  for (t; n > t; t++)
                    "metadata" === e[t].kind
                      ? ((e[t].oncuechange = ce), (e[t].mode = "showing"))
                      : ("subtitles" !== e[t].kind &&
                          "captions" !== e[t].kind) ||
                        ((e[t].mode = "disabled"),
                        We || (We = []),
                ...
                u(e, "change", se),
                  We &&
                    We.length &&
                    xe.trigger("subtitlesTracks", { tracks: We });
              }
            }
            function we(e) {
              We &&
                ...
                (Je > -1 && Je < We.length
                  ? (We[Je].mode = "disabled")
                  : i.each(We, function (e) {
                      e.mode = "disabled";
                    }),
                e > 0 && e <= We.length
                  ? ((Je = e - 1), (We[Je].mode = "showing"))
                  : (Je = -1),
            ...
            function je() {
              if ("hls" === _e[0].type) {
                ...
                0 === Ge.videoHeight && (e = "audio"),
                  xe.trigger("mediaType", { mediaType: e });
              }
            }
            function be() {
            ...
            (Ge = Ge || document.createElement("video")),
              ...
              i.isObject(A.cast) &&
                A.cast.appid &&
                Ge.setAttribute("disableRemotePlayback", ""),
              l(Ce, Ge),
              b || ((Ge.controls = !0), (Ge.controls = !1)),
              Ge.setAttribute("x-webkit-airplay", "allow"),
              Ge.setAttribute("webkit-playsinline", ""),
              (this.stop = function () {
                h(Re),
                  Me &&
                    (Q(), t.isIETrident() && Ge.pause(), this.setState(o.IDLE));
              }),
              (this.destroy = function () {
                c(Ce, Ge),
              ...
              (this.play = function () {
                return xe.seeking
                  ? (xe.setState(o.LOADING),
                    void xe.once(r.JWPLAYER_MEDIA_SEEKED, xe.play))
                  : void Ge.play();
              }),
              (this.pause = function () {
              ...
              (this.seek = function (e) {
                if (Me)
                  if (
                    (0 > e && (e += $() + Z()),
                    0 === Te &&
                      this.trigger(r.JWPLAYER_MEDIA_SEEK, {
              ...
              (this.setVisibility = function (t) {
                (t = !!t),
                  t || j
                    ? e.style(Ee, { visibility: "visible", opacity: 1 })
                    : e.style(Ee, { visibility: "", opacity: 0 });
              }),
              ...
              (this.setFullscreen = function (e) {
                if ((e = !!e)) {
                  var n = t.tryCatch(function () {
                    var e =
                      Ge.webkitEnterFullscreen || Ge.webkitEnterFullScreen;
                    e && e.apply(Ge);
                  });
        ...
        (r = function (e) {
          ...
          function n(t, n, i) {
            ...
            return "string" == typeof n && isNaN(n)
              ...
              ? "" + n + r
              : /color/i.test(t)
              ? "#" + e.pad(n.toString(16).replace(/^0x/i, ""), 6) + r
              : Math.ceil(n) + "px" + r;
          }
          var i,
            r = {},
            ...
            a = function (e, i) {
              if (void 0 !== e && null !== e) {
                ...
                for (var a = 0; a < e.length; a++) {
                  ...
                  if (void 0 !== l && null !== l)
                    for (r in o)
                      (s = t(r)), l.style[s] !== o[r] && (l.style[s] = o[r]);
                }
              }
            },
            s = function (e) {
              for (var t in r)
                t.indexOf(e) >= 0 && (i.removeChild(r[t]), delete r[t]);
            },
            l = function (e, t) {
              a(e, {
                transform: t,
            ...
            c = function (e, t) {
              ...
              return (
                void 0 !== t && 100 !== t && ((n += "a"), i.push(t / 100)),
                n + "(" + i.join(",") + ")"
              );
            };
          ...
          var n = e.extend({
            constructor: function (e) {
              (this.el = document.createElement("div")),
                (this.el.className =
                  "jw-icon jw-icon-tooltip " +
                  e +
                  " jw-button-color jw-reset jw-hidden"),
            ...
            openTooltip: function (e) {
              this.trigger("open-" + this.componentType, e, { isOpen: !0 }),
                (this.isOpen = !0),
                t.toggleClass(this.el, this.openClass, this.isOpen);
            },
            closeTooltip: function (e) {
              this.trigger("close-" + this.componentType, e, { isOpen: !1 }),
                (this.isOpen = !1),
                t.toggleClass(this.el, this.openClass, this.isOpen);
            },
    ...
    function (e, t, n) {
      ...
      (i = [n(283), n(1)]),
        (r = function (e, t) {
          ...
          return (
            (e.prototype.reorderProviders = function () {
              if (
                (i.apply(this),
                ...
                var e = t.indexOf(
                    this.providers,
                    t.findWhere(this.providers, { name: "caterpillar" })
                  ),
                  n = this.providers.splice(e, 1)[0],
                  r = t.indexOf(
                    this.providers,
                    t.findWhere(this.providers, { name: "flash" })
                  );
              ...
              return Promise.all(
                t.map(i, function (t) {
                  return new Promise(function (e) {
                    ...
                    t &&
                      (t.setEdition && t.setEdition(r), e.registerProvider(t));
                  });
                })
              );
            }),
    ...
    function (e, t, n) {
      var i, r;
      (i = [n(2), n(47), n(120), n(273), n(1), n(3), n(287), n(4), n(6)]),
        (r = function (e, t, n, i, r, o, a, s, l) {
          var c = ["volume", "mute", "captionLabel", "qualityLabel"],
            u = function () {
              function a(e, t) {
                switch (e) {
                  ...
                  case s.JWPLAYER_MEDIA_META:
                    var i = t.duration;
                    r.isNumber(i) &&
                      (this.mediaModel.set("duration", i),
                      this.set("duration", i));
                    break;
              ...
              var u,
                ...
                f = this,
                h = e.noop;
              (this.mediaController = r.extend({}, o)),
                (this.mediaModel = new d()),
                i.model(this),
                ...
                (this.setup = function (t) {
                  ...
                  return (
                    i.track(c, this),
                    r.extend(this.attributes, i.getAllItems(), t, {
                      item: 0,
                      state: l.IDLE,
                      flashBlocked: !1,
                      fullscreen: !1,
                ...
                (this.setFullscreen = function (e) {
                  (e = !!e),
                    e !== f.get("fullscreen") && f.set("fullscreen", e);
                }),
                ...
                (this.setActiveItem = function (e) {
                  ...
                  if (void 0 !== t) {
                    ...
                    h instanceof n || f.changeVideoProvider(n),
                      h.init && h.init(e),
                ...
                (this.setVideoSubtitleTrack = function (e, t) {
                  this.set("captionsIndex", e),
                    ...
                    p && p.setSubtitlesTrack && p.setSubtitlesTrack(e);
                }),
                ...
                function (i, r) {
                  if (
                    ...
                    if (d > 0) {
                      ...
                      if ("PRIV" === r.value.key) {
                        if (
                          "com.apple.streaming.transportStreamTimestamp" === f
                        ) {
                      ...
                      var m = a[c];
                      1 === m || 2 === m
                        ? (r.value.data = t.utf16BigEndianArrayToStr(a, c + 1))
                        : (r.value.data = t.utf8ArrayToStr(a, c + 1));
                    }
                  }
                  if (
                    ...
                    var v = i[r.value.key];
                    e.isObject(v) || ((v = {}), (i[r.value.key] = v)),
          ...
          return (
            ...
            (t.available = function (n) {
              ...
              return (
                e &&
                  e.cast &&
                  e.cast.ReceiverAvailability &&
                  (i = e.cast.ReceiverAvailability.AVAILABLE),
                n === i
              );
            }),
            (t.log = function () {
          ...
          var r = e.extend({
            ...
            setup: function () {
              ...
              (this.el = i.createElement(n(e))),
                ...
                (this.elementThumb =
                  this.el.getElementsByClassName("jw-knob")[0]),
            ...
            dragMove: function (e) {
              var t,
                n,
                r = (this.railBounds = this.railBounds
                  ? this.railBounds
                  : i.bounds(this.elementRail));
                ...
                ? ((t = e.pageX),
                  (n =
                    t < r.left
                      ...
                      : t > r.right
                      ? 100
                      : 100 * i.between((t - r.left) / r.width, 0, 1)))
                : ((t = e.pageY),
                  (n =
                    t >= r.bottom
                      ? 0
                      ...
                      ? 100
                      : 100 *
                        i.between((r.height - (t - r.top)) / r.height, 0, 1)));
              var o = this.limit(n);
      ...
      (i = [n(129), n(48), n(1), n(282)]),
        (r = function (e, t, n, i) {
          ...
          function a(i, a) {
            ...
            return (
              i.mediaTypes &&
                (c = n.all(i.mediaTypes, function (e) {
        ...
        (r = function (e, t) {
          ...
          var a = {
            ...
            s = function (s) {
              ...
              var c = t.extend({}, a, l);
              if (
                ("." === c.base && (c.base = e.getScriptPath("jwplayer.js")),
                (c.base = (c.base || e.loadFrom()).replace(/\/?$/, "/")),
                (n.p = c.base),
                (c.width = r(c.width)),
                (c.height = r(c.height)),
                (c.flashplayer =
                  c.flashplayer ||
                  e.getScriptPath("jwplayer.js") + "jwplayer.flash.swf"),
                "http:" === window.location.protocol &&
                  (c.flashplayer = c.flashplayer.replace("https", "http")),
                (c.aspectratio = o(c.aspectratio, c.width)),
                t.isObject(c.skin) &&
                  ((c.skinUrl = c.skin.url),
                  (c.skinColorInactive = c.skin.inactive),
                  (c.skinColorActive = c.skin.active),
                  (c.skinColorBackground = c.skin.background),
                  (c.skin = t.isString(c.skin.name) ? c.skin.name : a.skin)),
                t.isString(c.skin) &&
                  c.skin.indexOf(".xml") > 0 &&
                  (console.log(
                    "JW Player does not support XML skins, please update your config"
                  ),
                  (c.skin = c.skin.replace(".xml", ""))),
    ...
    function (e, t, n) {
      ...
      (i = [n(1), n(2)]),
        (r = function (e, t) {
          ...
          return (
            e.extend(a.prototype, { getAllItems: i, track: s, clear: o }), a
          );
        }.apply(t, i)),
        !(void 0 !== r && (e.exports = r));
    },
            ...
            function a(r) {
              var a = n.tryCatch(function () {
                ...
                if (a) {
                  for (
                    var u = 0;
                    u < a.length && ((s = a[u]), 8 === s.nodeType);
                    u++
                  );
                  "xml" === e.localName(s) && (s = s.nextSibling),
                    "rss" === e.localName(s) && (n = { playlist: t.parse(s) });
                }
                if (!n)
                  try {
                    var d = JSON.parse(r.responseText);
                    if (o.isArray(d)) n = { playlist: d };
                    else {
              ...
              (this.load = function () {
                if (m === r.loaderstatus.NEW) {
                  ...
                  if (t.getPluginPathType(s) === t.pluginPathType.CDN)
                    return (
                      (m = r.loaderstatus.COMPLETE), void g.trigger(n.COMPLETE)
                    );
                  ...
                  if (d)
                    switch (t.getPluginPathType(d)) {
                      case t.pluginPathType.ABSOLUTE:
                        return d;
                      case t.pluginPathType.RELATIVE:
                        return s.lastIndexOf(".swf") > 0
                          ? e.getAbsolutePath(d, window.location.href)
                          : e.getAbsolutePath(d, l());
                    }
                  return null;
                }),
                (this.getJS = function () {
                ...
                (this.getPluginmode = function () {
                  return void 0 !== typeof d && void 0 !== typeof p
                    ? a.HYBRID
                    : void 0 !== typeof d
                    ? a.FLASH
                    : void 0 !== typeof p
      ...
      (i = [n(1)]),
        (r = function (e) {
          ...
          (n.isChrome = function () {
            ...
            (n.isIE = function (e) {
              return e
                ? ((e = parseFloat(e).toFixed(1)), e >= 11 ? o(e) : a(e))
                : a() || o();
            }),
            (n.isSafari = function () {
              return (
          ...
          var c = (n.isAndroid = function (e, t) {
            return t && i(/chrome\/[123456789]/i) && !i(/chrome\/18/)
              ? !1
              : e
              ? (r(e) && !/\./.test(e) && (e = "" + e + "."),
          ...
          return (
            ...
            (n.isIframe = function () {
              return (
                window.frameElement && "IFRAME" === window.frameElement.nodeName
              );
            }),
            ...
            return (
              (o.setup = function () {
                ...
                r.on("change:skipButton", this.onSkipButton, this),
                  r.on(
                    "change:castActive change:playlistItem",
                    this.showDisplayIconImage,
                    this
                  );
              }),
              (o.showDisplayIconImage = function (e) {
                var t = e.get("castActive"),
                  ...
                  i = o
                    .controlsContainer()
                    .getElementsByClassName("jw-display-icon-container")[0];
                t && n && n.image
                  ? ((i.style.backgroundImage = 'url("' + n.image + '")'),
      ...
      e.exports = (i["default"] || i).template({
        1: function (e, t, n, i, r) {
          ...
          return (
            ...
            (null !=
            (o = n["if"].call(s, null != t ? t.btnClass : t, {
              name: "if",
              hash: {},
              fn: e.program(2, r, 0),
              inverse: e.noop,
            ...
            e.escapeExpression(
              ((a =
                null != (a = n.id || (null != t ? t.id : t))
                  ? a
                  : n.helperMissing),
              "function" == typeof a
                ? a.call(s, { name: "id", hash: {}, data: r })
                : a)
            ) +
            '">\n        <div class="jw-icon jw-dock-image jw-reset" ' +
            (null !=
            (o = n["if"].call(s, null != t ? t.img : t, {
              name: "if",
              hash: {},
              fn: e.program(4, r, 0),
              inverse: e.noop,
            ...
            (null !=
            (o = n["if"].call(s, null != t ? t.tooltip : t, {
              name: "if",
              hash: {},
              fn: e.program(6, r, 0),
              inverse: e.noop,
        ...
        2: function (e, t, n, i, r) {
          ...
          return (
            ...
            e.escapeExpression(
              ((o =
                null != (o = n.btnClass || (null != t ? t.btnClass : t))
                  ? o
                  : n.helperMissing),
              "function" == typeof o
                ? o.call(null != t ? t : {}, {
        ...
        4: function (e, t, n, i, r) {
          ...
          return (
            ...
            e.escapeExpression(
              ((o =
                null != (o = n.img || (null != t ? t.img : t))
                  ? o
                  : n.helperMissing),
              "function" == typeof o
                ? o.call(null != t ? t : {}, { name: "img", hash: {}, data: r })
                : o)
            ) +
            "\")'"
          );
        ...
        main: function (e, t, n, i, r) {
          ...
          return (
            ...
            c(
              ...
              typeof o === l ? o.call(a, { name: "id", hash: {}, data: r }) : o)
            ) +
            '"class="jw-skin-' +
            c(
              ((o = null != (o = n.skin || (null != t ? t.skin : t)) ? o : s),
              typeof o === l
                ? o.call(a, { name: "skin", hash: {}, data: r })
                : o)
            ) +
            ...
            c(
              ...
              typeof o === l
                ? o.call(a, { name: "title", hash: {}, data: r })
                : o)
            ) +
            '</div>\n        <div class="jw-title-secondary jw-reset">' +
            c(
              ((o = null != (o = n.body || (null != t ? t.body : t)) ? o : s),
              typeof o === l
                ? o.call(a, { name: "body", hash: {}, data: r })
                : o)
            ) +
      ...
      e.exports = (i["default"] || i).template({
        1: function (e, t, n, i, r) {
          ...
          return (
            ...
            a(
              ((o =
                null != (o = n.index || (r && r.index)) ? o : n.helperMissing),
              "function" == typeof o
                ? o.call(null != t ? t : {}, {
                    name: "index",
                    hash: {},
            ...
            e.escapeExpression(
              ((o =
                null != (o = n.id || (null != t ? t.id : t))
                  ...
                  : n.helperMissing),
              "function" == typeof o
                ? o.call(null != t ? t : {}, { name: "id", hash: {}, data: r })
                : o)
            ) +
    ...
    function (e, t, n) {
      ...
      e.exports = (i["default"] || i).template({
        1: function (e, t, n, i, r) {
          var o;
          return null !=
            (o = n["if"].call(null != t ? t : {}, null != t ? t.active : t, {
              name: "if",
              hash: {},
              fn: e.program(2, r, 0),
      ...
      e.exports = (i["default"] || i).template({
        1: function (e, t, n, i, r) {
          ...
          return (
            '        <li class="jw-reset' +
            (null !=
            (o = n["if"].call(s, null != t ? t.featured : t, {
              name: "if",
              hash: {},
              fn: e.program(2, r, 0),
              inverse: e.noop,
            ...
            '">\n            <a href="' +
            u(
              ((a = null != (a = n.link || (null != t ? t.link : t)) ? a : l),
              typeof a === c
                ? a.call(s, { name: "link", hash: {}, data: r })
                : a)
            ) +
            '" class="jw-reset" target="_top">\n' +
            (null !=
            (o = n["if"].call(s, null != t ? t.showLogo : t, {
              name: "if",
              hash: {},
              fn: e.program(4, r, 0),
              inverse: e.noop,
            ...
            "                " +
            u(
              ((a = null != (a = n.title || (null != t ? t.title : t)) ? a : l),
              typeof a === c
                ? a.call(s, { name: "title", hash: {}, data: r })
                : a)
            ) +
            "\n            </a>\n        </li>\n"
          );
        ...
        main: function (e, t, n, i, r) {
          ...
          return (
            ...
            (null !=
            (o = n.each.call(null != t ? t : {}, null != t ? t.items : t, {
              name: "each",
              hash: {},
              fn: e.program(1, r, 0),
              inverse: e.noop,
      ...
      e.exports = (i["default"] || i).template({
        ...
        main: function (e, t, n, i, r) {
          ...
          return (
            ...
            c(
              ((o =
                null != (o = n.className || (null != t ? t.className : t))
                  ? o
                  : s),
              typeof o === l
                ? o.call(a, { name: "className", hash: {}, data: r })
                : o)
            ) +
            " " +
            c(
              ((o =
                null != (o = n.orientation || (null != t ? t.orientation : t))
                  ? o
                  : s),
              typeof o === l
                ? o.call(a, { name: "orientation", hash: {}, data: r })
                : o)
            ) +
      ...
      (t["default"] = function (e) {
        e.registerHelper("each", function (e, t) {
          ...
          if (
            (t.data &&
              t.ids &&
              (u = r.appendContextPath(t.data.contextPath, t.ids[0]) + "."),
    ...
    function (e, t, n) {
      ...
      function a(e, t) {
        function n(n, i, r) {
          r.hash && ((i = h.extend({}, i, r.hash)), r.ids && (r.ids[0] = !0)),
        ...
        var r = {
          ...
          program: function (e, t, n, i, r) {
            ...
            return (
              t || r || i || n
                ? (o = s(this, e, a, t, n, i, r))
                : o || (o = this.programs[e] = s(this, e, a)),
              o
            );
          },
          data: function (e, t) {
          ...
          var p = function (o, p) {
            ...
            var v = function () {
              (f = new s(o)),
                l(h, f),
                c(h, f),
                f.on(e.JWPLAYER_PLAYLIST_ITEM, function () {
                  m = {};
                }),
            ...
            return (
              ...
              (this.qoe = function () {
                var t = f.getItemQoe(),
                  ...
                  i = t.between(
                    e.JWPLAYER_MEDIA_PLAY_ATTEMPT,
                    e.JWPLAYER_MEDIA_FIRST_FRAME
                  );
                return {
                  setupTime: n,
                  firstFrame: i,
    ...
    function (e, t, n) {
      var i, r;
      (i = [n(264), n(1), n(47), n(128), n(89), n(41)]),
        (r = function (e, t, n, i, r, o) {
          var a = [],
            s = 0,
            l = function (t) {
              ...
              return (
                t
                  ? "string" == typeof t
                    ? ((n = c(t)), n || (i = document.getElementById(t)))
                    : "number" == typeof t
                    ? (n = a[t])
                    : t.nodeType && ((i = t), (n = c(i.id)))
                  : (n = a[0]),
                n
                  ? n
                  : i
        ...
        (r = function (e, t, n, i) {
          var r = function (t, r, o, a) {
            function s() {
              p(
                "Setup Timeout Error",
                "Setup took longer than " + m + " seconds to complete."
              );
            }
            function l() {
              n.each(g, function (e) {
            ...
            function d(e, t) {
              "error" === t.type
                ? p(t.msg, t.reason)
                : "complete" === t.type
                ? (clearTimeout(f), h.trigger(i.JWPLAYER_READY))
                : ((e.complete = !0), l());
            }
            function p(e, t) {
              clearTimeout(f),
          ...
          var r = function (r, o) {
            ...
            function s(e) {
              ...
              if (t && "textdata" === t.type) {
                ...
                var r, a;
                t.useDTS
                  ? (n.source || (n.source = t.source || "mpegts"),
                    (r = t.begin),
                    (a = t.begin + "_" + t.text))
                  : ((r = e.position || o.get("position")),
                    (a = "" + Math.round(10 * r) + "_" + t.text));
                var s = E[a];
                s ||
                  ((s = { begin: r, text: t.text }),
                  t.end && (s.end = t.end),
                  (E[a] = s),
                  n.data.push(s));
              }
            ...
            function u(e) {
              ...
              for (l = 0; l < u.length; l++)
                (t = u[l]),
                  ...
                  (d && r && !w && h) ||
                    ((n = t.kind.toLowerCase()),
                    ("captions" !== n && "subtitles" !== n) ||
                      (t.file ? (p(t), f(t)) : t.data && p(t)));
              j.length ||
            ...
            function p(e) {
              "number" != typeof e.id &&
                (e.id = e.name || e.file || "cc" + j.length),
                (e.data = e.data || []),
                e.label ||
                  ((e.label = "Unknown CC"),
                  k++,
            ...
            function h(r, o) {
              var a,
                s = r.responseXML ? r.responseXML.firstChild : null;
              if (s)
                for (
                  "xml" === e.localName(s) && (s = s.nextSibling);
            ...
            function g() {
              for (
                ...
                e.push({ id: j[t].id, label: j[t].label || "Unknown CC" });
              return e;
            }
            function m() {
              var e = 0,
              ...
              for (var n = 0; n < j.length; n++) {
                ...
                i["default"] || i.defaulttrack || "default" === i.id
                  ? (e = n + 1)
                  : i.autoselect;
              }
              v(e);
    ...
    function (e, t, n) {
      ...
      (i = [
        ...
        (r = function (e, t, n, i, r, o, a, s, l, c, u, d, p, f, h) {
          function g(e) {
            return function () {
            ...
            (v.prototype = {
              ...
              setup: function (o, u) {
                ...
                function g() {
                  (K = null),
                    C(H.get("item")),
                    H.on("change:state", d, this),
                    H.on("change:castState", function (e, t) {
                      Z.trigger(f.JWPLAYER_CAST_SESSION, t);
                    }),
                    H.on("change:fullscreen", function (e, t) {
                      Z.trigger(f.JWPLAYER_FULLSCREEN, { fullscreen: t });
                    }),
                    ...
                    H.on("change:playlist", function (e, t) {
                      t.length &&
                        Z.trigger(f.JWPLAYER_PLAYLIST_LOADED, { playlist: t });
                    }),
                    H.on("change:volume", function (e, t) {
                      Z.trigger(f.JWPLAYER_MEDIA_VOLUME, { volume: t });
                    }),
                    H.on("change:mute", function (e, t) {
                      Z.trigger(f.JWPLAYER_MEDIA_MUTE, { mute: t });
                    }),
                    H.on("change:controls", function (e, t) {
                      Z.trigger(f.JWPLAYER_CONTROLS, { controls: t });
                    }),
                    ...
                    H.mediaController.on("all", Z.trigger.bind(Z)),
                    z.on("all", Z.trigger.bind(Z)),
                ...
                function v() {
                  for (
                    Z.trigger(f.JWPLAYER_READY, { setupTime: 0 }),
                      ...
                      H.get("autostart") && b({ reason: "autostart" });
                ...
                function w(e) {
                  switch (
                    (H.get("state") === p.ERROR && H.set("state", p.IDLE),
                    E(!0),
                    H.get("autostart") && H.once("itemReady", b),
                    typeof e)
                  ) {
                    case "string":
                      y(e);
                ...
                function b(e) {
                  var t;
                  if (
                    (e && H.set("playReason", e.reason),
                    H.get("state") !== p.ERROR)
                  ) {
                    var i = Z._instreamAdapter && Z._instreamAdapter.getState();
                    if (n.isString(i)) return u.pauseAd(!1);
                    if (
                      (H.get("state") === p.COMPLETE && (E(!0), C(0)),
                      !X &&
                        ((X = !0),
                        Z.trigger(f.JWPLAYER_MEDIA_BEFOREPLAY, {
                          playReason: H.get("playReason"),
                        }),
                        (X = !1),
                        q))
                    )
                      return (q = !1), void (Q = null);
                    if (A()) {
                      ...
                      H.get("state") === p.PAUSED &&
                        (t = l.tryCatch(function () {
                          H.playVideo();
                        }));
                    return t instanceof l.Error
                      ? (Z.triggerError(t), (Q = null), !1)
                      : !0;
                  }
                }
                function E(e) {
                ...
                function C(e) {
                  ...
                  (e = parseInt(e, 10) || 0),
                    ...
                    H.set("item", e),
                    H.set("playlistItem", t[e]),
                    H.setActiveItem(t[e]);
                }
                function P(e) {
                  _(H.get("item") - 1, e || { reason: "external" });
                }
                function T(e) {
                  _(H.get("item") + 1, e || { reason: "external" });
                }
                function R() {
                  if (A()) {
                    ...
                    Q = R;
                    var e = H.get("item");
                    return e === H.get("playlist").length - 1
                      ? void (H.get("repeat")
                          ? T({ reason: "repeat" })
                          : (H.set("state", p.COMPLETE),
                            Z.trigger(f.JWPLAYER_PLAYLIST_COMPLETE, {})))
                      : void T({ reason: "playlist" });
                  }
                }
                function I(e) {
                  ee() &&
                    ((e = parseInt(e, 10) || 0), ee().setCurrentQuality(e));
                }
                function M() {
                ...
                function Y(e) {
                  ee() &&
                    ((e = parseInt(e, 10) || 0), ee().setCurrentAudioTrack(e));
                }
                function N() {
                ...
                function F(e) {
                  (e = parseInt(e, 10) || 0),
                    H.persistVideoSubtitleTrack(e),
                    Z.trigger(f.JWPLAYER_CAPTIONS_CHANGED, {
                      tracks: V(),
                      track: e,
                    });
                }
                ...
                function U() {
                  ...
                  return e instanceof l.Error
                    ? void l.log("Error calling _attachMedia", e)
                    : void ("function" == typeof Q && Q());
                }
                var H,
                  z,
                  G,
                  ...
                  te = new e(o);
                (H = this._model.setup(te)),
                  (z = this._view = new c(u, H)),
                  (G = new r(u, H)),
                  (K = new i(u, H, z, x)),
                  K.on(f.JWPLAYER_READY, g, this),
                  K.on(f.JWPLAYER_SETUP_ERROR, this.setupError, this),
                  H.mediaController.on(f.JWPLAYER_MEDIA_COMPLETE, function () {
                    n.defer(R);
                  }),
                  H.mediaController.on(
                    f.JWPLAYER_MEDIA_ERROR,
                    this.triggerError,
                    this
                  ),
                  H.on(
                    ...
                    function (e, t) {
                      ...
                      n || this.trigger(f.JWPLAYER_ERROR, i),
                        this._model.set("errorEvent", i);
                    },
                    this
                  ),
                  h(),
                  H.on("change:mediaModel", h),
                  (this.play = b),
                  (this.pause = k),
                  (this.seek = L),
                  (this.stop = E),
                  ...
                  (this.playlistPrev = P),
                  (this.playlistItem = _),
                  (this.setCurrentCaptions = F),
                  (this.setCurrentQuality = I),
                  (this.detachMedia = B),
                  (this.attachMedia = U),
                  (this.getCurrentQuality = M),
                  (this.getQualityLevels = D),
                  (this.setCurrentAudioTrack = Y),
                  (this.getCurrentAudioTrack = N),
                  (this.getAudioTracks = W),
                  (this.getCurrentCaptions = J),
                  (this.getCaptionsList = V),
                  (this.getVisualQuality = O),
                  (this.getConfig = S),
                  (this.getState = j),
                  (this.setVolume = H.setVolume),
                  (this.setMute = H.setMute),
                  ...
                  (this.setFullscreen = function (e) {
                    n.isBoolean(e) || (e = !H.get("fullscreen")),
                      H.set("fullscreen", e),
                  ...
                  (this.addButton = function (e, t, i, r, o) {
                    var a = {
                      ...
                      s = H.get("dock");
                    (s = s ? s.slice(0) : []),
                      (s = n.reject(s, n.matches({ id: a.id }))),
                      s.push(a),
                      H.set("dock", s);
                  }),
                  (this.removeButton = function (e) {
                    var t = H.get("dock") || [];
                    (t = n.reject(t, n.matches({ id: e }))), H.set("dock", t);
                  }),
                  ...
                  (this.setControls = function (e) {
                    n.isBoolean(e) || (e = !H.get("controls")),
                      H.set("controls", e);
                    var t = H.getVideo();
                    t && t.setControls(e);
                  }),
                  ...
                  (this.createInstream = function () {
                    return (
                      ...
                      (this._instreamAdapter = new t(this, H, z)),
                      this._instreamAdapter
                    );
                  }),
              ...
              showView: function (e) {
                (document.documentElement.contains(this.currentContainer) ||
                  ((this.currentContainer = document.getElementById(
                    this._model.get("id")
                  )),
              ...
              triggerError: function (e) {
                this._model.set("errorEvent", e),
                  ...
                  this.trigger(f.JWPLAYER_ERROR, e);
              },
              setupError: function (e) {
                var t = e.message,
                  i = l.createElement(
                    h(this._model.get("id"), this._model.get("skin"), t)
                  ),
                ...
                var a = this;
                n.defer(function () {
                  a.trigger(f.JWPLAYER_SETUP_ERROR, { message: t });
                });
              },
            }),
            v
    ...
    function (e, t, n) {
      var i, r;
      (i = [n(272), n(271), n(4), n(6), n(2), n(3), n(1)]),
        (r = function (e, t, n, i, r, o, a) {
          function s(n) {
              ...
              var p,
                ...
                b = a.bind(function (e) {
                  (e = e || {}),
                    ...
                    w &&
                      w._adModel &&
                      (w._adModel.get("state") === i.PAUSED
                        ? e.hasControls && w.instreamPlay()
                        : w.instreamPause());
                }, this),
                E = a.bind(function () {
                  w &&
              ...
              (this.type = "instream"),
                (this.init = function () {
                  (h = t.getVideo()),
                    ...
                    e.checkBeforePlay() || (0 === g && !h.checkComplete())
                      ? ((g = 0), t.set("preInstreamState", "instream-preroll"))
                      : (h && h.checkComplete()) ||
                        t.get("state") === i.COMPLETE
                      ? t.set("preInstreamState", "instream-postroll")
                      : t.set("preInstreamState", "instream-midroll");
                  var a = t.get("state");
                  return (
                    (a !== i.PLAYING && a !== i.BUFFERING) || h.pause(),
                ...
                (this.loadItem = function (e, i) {
                  ...
                  o &&
                    (w._adModel.set("skipMessage", j.skipMessage),
                ...
                (this.destroy = function () {
                  if ((this.off(), t.set("skipButton", !1), w)) {
                    o.clickHandler() &&
                      o.clickHandler().revertAlternateClickHandlers(),
                      w.instreamDestroy(),
                      o.destroyInstream(),
                      (w = null),
                      e.attachMedia();
                    ...
                    switch (n) {
                      ...
                      case "instream-midroll":
                        ...
                        (s.starttime = g),
                          t.loadVideo(s),
                          r.isMobile() &&
                            t.mediaModel.get("state") === i.BUFFERING &&
                            h.setState(i.BUFFERING),
                          h.play();
                        break;
    ...
    function (e, t, n) {
      var i, r;
      (i = [n(3), n(55), n(83), n(4), n(6), n(2), n(1)]),
        (r = function (e, t, n, i, r, o, a) {
          var s = function (e, i) {
            (this.model = i),
            ...
            return (
              ...
              (this.instreamDestroy = function () {
                p &&
                  (p.off(),
                  this.off(),
                  f && (f.detachMedia(), f.off(), p.getVideo() && f.destroy()),
                  (p = null),
    ...
    function (e, t, n) {
      ...
      (i = [n(133), n(4), n(1)]),
        (r = function (e, t, n) {
          function i(e) {
            e.mediaController.off(
              t.JWPLAYER_MEDIA_PLAY_ATTEMPT,
              e._onPlayAttempt
            ),
              e.mediaController.off(
                t.JWPLAYER_PROVIDER_FIRST_FRAME,
          ...
          function r(e) {
            i(e),
              ...
              e.mediaController.on(
                t.JWPLAYER_MEDIA_PLAY_ATTEMPT,
                e._onPlayAttempt
              ),
              e.mediaController.once(
                t.JWPLAYER_PROVIDER_FIRST_FRAME,
                e._triggerFirstFrame
              ),
    ...
    function (e, t, n) {
      var i, r;
      (i = [n(47), n(41), n(122), n(32), n(44), n(1), n(2), n(4)]),
        (r = function (e, t, i, r, o, a, s, l) {
          function c() {
            var e = {
              ...
              LOAD_PLUGINS: { method: f, depends: ["LOADED_POLYFILLS"] },
              INIT_PLUGINS: {
                method: h,
          ...
          function w(e, t) {
            t && t.message
              ? L(e, "Error loading playlist", t.message)
              : L(e, "Error loading player", "No playable sources found");
          }
          function y(e, t) {
            return a.contains(o.SkinsLoadable, e)
              ? t + "skins/" + e + ".css"
              : void 0;
          }
          function j(e) {
        ...
        (r = function (e, t, n) {
          var i = "jwplayer",
            r = function (r, o) {
              ...
              if (a.length)
                for (o.sources = [], f = 0; f < a.length; f++)
                  a[f].file.length > 0 &&
                    ((a[f][c] = "true" === a[f][c]),
                    a[f].label.length || delete a[f].label,
                    o.sources.push(a[f]));
              if (s.length)
                for (o.tracks = [], f = 0; f < s.length; f++)
                  s[f].file.length > 0 &&
                    ((s[f][c] = "true" === s[f][c]),
                    (s[f].kind = s[f].kind.length ? s[f].kind : "captions"),
                    s[f].label.length || delete s[f].label,
                    o.tracks.push(s[f]));
              return o;
            };
          return r;
              ...
              for (d = 0; d < a(e); d++)
                if (((u = e.childNodes[d]), u.prefix === s)) {
                  ...
                  switch (r(u).toLowerCase()) {
                    case "content":
                      i(u, "duration") &&
                        (t.duration = n.seconds(i(u, "duration"))),
                        a(u) > 0 && (t = l(u, t)),
                        i(u, "url") &&
                          (t.sources || (t.sources = []),
                          t.sources.push({
                    ...
                    case "subtitle":
                      ...
                      (h.file = i(u, "url")),
                        (h.kind = "captions"),
                        i(u, "lang").length > 0 && (h.label = c(i(u, "lang"))),
                        f.push(h);
                  }
                }
              for (t.hasOwnProperty(p) || (t[p] = []), d = 0; d < f.length; d++)
                t[p].push(f[d]);
              return t;
            };
          return l;
          ...
          var l = function (l, c) {
            ...
            (this.setupPlugins = function (n, i) {
              ...
              r.each(u, function (i, l) {
                ...
                if (f) {
                  var m = r.extend(
                    { name: d, swf: f, pluginmode: p.getPluginmode() },
                    i
                  );
                  o.push(m);
                }
                ...
                v instanceof t.Error &&
                  t.log("ERROR: Failed to load " + d + ".");
              }),
            ...
            r.extend(o.prototype, {
              reorderProviders: function () {
                if ("flash" === this.config.primary) {
                  var e = r.indexOf(
                      this.providers,
                      r.findWhere(this.providers, { name: "flash" })
                    ),
                    t = this.providers.splice(e, 1)[0],
                    n = r.indexOf(
                      this.providers,
                      r.findWhere(this.providers, { name: "html5" })
                    );
              ...
              required: function (e, t) {
                return (
                  (e = e.slice()),
                  r.compact(
                    r.map(this.providers, function (n) {
          ...
          var l = function () {},
            ...
            d = function (t, a, s, d) {
              ...
              if ("XDomainRequest" in window && u(t))
                (p = f.xhr = new window.XDomainRequest()),
                  (p.onload = o(f)),
                ...
                (p = f.xhr = new window.XMLHttpRequest()),
                  (p.onreadystatechange = r(f));
              }
              var h = i("Error loading file", f);
              (p.onerror = h),
                "overrideMimeType" in p
                  ? f.mimeType && p.overrideMimeType(f.mimeType)
                  : (c = !0);
              try {
        ...
        (r = function (e, t, n) {
          ...
          function r(r, o, l, c) {
            ...
            if (((c = c || "opaque"), e.isMSIE())) {
              ...
              for (
                var p = o.getElementsByTagName("object"), f = p.length;
                f--;
            ...
            return (
              ...
              (u.triggerFlash = function (t) {
                ...
                return l instanceof e.Error &&
                  (console.error(t, l), "setup" === t)
                  ? ((l.name = "Failed to setup flash"), l)
                  : i;
              }),
              (u.__commandQueue = []),
              u
          ...
          var r = t.style,
            ...
            a = function (a) {
              function s(t) {
                ...
                t
                  ? ((y.innerHTML = t),
                    (w.className = n + " jw-captions-window-active"))
                  : ((w.className = n), e.empty(y));
              }
              function l(e) {
                (m = e), u(h, m);
              }
                ...
                if (e && e.data && t) {
                  ...
                  if (n !== !1) {
                    ...
                    if (!(g >= 0 && d(i, g, n))) {
                      ...
                      -1 === r
                        ? s("")
                        : r !== g && ((g = r), s(j.preprocessor(i[g].text)));
                    }
                  }
                }
              }
        ...
        (r = function (e, t, n) {
          ...
          var r = {
            ...
            drawCues: function () {
              ...
              if (!t || 0 >= t)
                return void this._model.mediaModel.once(
                  "change:duration",
                  this.drawCues,
                  this
                );
          ...
          var r = e.extend({
            ...
            setup: function (e, r) {
              this.iconUI ||
                ...
                (this.toggleOpenStateListener =
                  this.toggleOpenState.bind(this)),
                ...
                t.toggleClass(
                  this.el,
                  "jw-hidden",
                  !r || this.activeContents.length < 2
                ),
                r &&
          ...
          var o = e.extend({
            setup: function (e, o, a) {
              ...
              var s = e.length > 2 || (2 === e.length && a && a.toggle === !1),
                l = !s && 2 === e.length;
              if (
                (t.toggleClass(this.el, "jw-toggle", l),
                ...
                var c = r(e),
                  u = t.createElement(c);
                this.addContent(u),
                  (this.contentUI = new i(this.content).on(
                    "click tap",
                    this.selectListener
                  ));
            ...
            select: function (e) {
              if (e.target.parentElement === this.content) {
                ...
                r &&
                  (this.trigger("select", parseInt(r.split("-")[2])),
    ...
    function (e, t, n) {
      var i, r;
      (i = [n(2), n(1), n(46), n(12), n(243)]),
        (r = function (e, t, n, i, r) {
          var o = n.extend({
            setup: function (n, r) {
              if (
                (this.iconUI ||
                  ((this.iconUI = new i(this.el, { useHover: !0 })),
                  (this.toggleOpenStateListener =
                    this.toggleOpenState.bind(this)),
                  (this.openTooltipListener = this.openTooltip.bind(this)),
                  (this.closeTooltipListener = this.closeTooltip.bind(this)),
            ...
            onSelect: function (n) {
              ...
              if ("UL" !== i.tagName) {
                ...
                o &&
                  (this.trigger("select", parseInt(o.split("-")[2])),
                  this.closeTooltip());
              }
            },
            selectItem: function (e) {
    ...
    function (e, t, n) {
      var i, r;
      (i = [n(1), n(2), n(44), n(88), n(46), n(290), n(294)]),
        (r = function (e, t, n, i, r, o, a) {
          var s = r.extend({
              setup: function () {
            ...
            l = i.extend({
              ...
              setup: function () {
                i.prototype.setup.apply(this, arguments),
                  ...
                  this.el.addEventListener(
                    "mousemove",
                    this.showTimeTooltip.bind(this),
                    !1
                  ),
                  this.el.addEventListener(
                    "mouseout",
                    this.hideTimeTooltip.bind(this),
                    !1
                  );
              },
              limit: function (i) {
              ...
              performSeek: function () {
                ...
                0 === i
                  ? this._api.play()
                  : "DVR" === r
                  ? ((e = ((100 - n) / 100) * i), this._api.seek(e))
                  : ((e = (n / 100) * i),
    ...
    function (e, t, n) {
      var i, r;
      (i = [n(46), n(88), n(12), n(2)]),
        (r = function (e, t, n, i) {
          var r = e.extend({
            constructor: function (r, o) {
              (this._model = r),
                e.call(this, o),
                (this.volumeSlider = new t(
                ...
                new n(this.el, { useHover: !0, directSelect: !0 })
          ...
          return (
            t.extend(g.prototype, n, {
              ...
              build: function () {
                ...
                this._model.get("visualplaylist") !== !1 &&
                  (e = new l("jw-icon-playlist")),
                  this._isMobile ||
                    ((r = d("jw-icon-volume", this._api.setMute)),
                  ...
                  (this.elements = {
                    ...
                    play: d(
                      "jw-icon-playback",
                      this._api.play.bind(this, { reason: "interaction" })
                    ),
                    prev: d(
                      "jw-icon-prev",
                      this._api.playlistPrev.bind(this, {
                        reason: "interaction",
                      })
                    ),
                    next: d(
                      "jw-icon-next",
                      this._api.playlistNext.bind(this, {
                        reason: "interaction",
                      })
                    ),
                    playlist: e,
              ...
              initialize: function () {
                this.elements.play.show(),
                  ...
                  this.onCastAvailable(
                    this._model,
                    this._model.get("castAvailable")
                  ),
                  this.onCastActive(this._model, this._model.get("castActive")),
                  this.onCaptionsList(
                    this._model,
                    this._model.get("captionsList")
                  ),
                  this._model.on("change:volume", this.onVolume, this),
                  ...
                  this.elements.hd.on(
                    ...
                    function () {
                      this._model
                        .getVideo()
                        .setCurrentQuality(
                          0 === this._model.getVideo().getCurrentQuality()
                            ? 1
                            : 0
                        );
                    },
                  ...
                  new r(this.elements.duration).on(
                    "click tap",
                    function () {
                      if (
                        "DVR" === e.adaptiveType(this._model.get("duration"))
                      ) {
              ...
              onPlaylist: function (e, t) {
                ...
                this.elements.next.toggle(n),
                  ...
                  this.elements.playlist &&
                    this.elements.playlist.setup(t, e.get("item"));
              },
              ...
              renderVolume: function (t, n) {
                this.elements.mute &&
                  e.toggleClass(this.elements.mute.element(), "jw-off", t),
                  this.elements.volume &&
                    this.elements.volume.render(t ? 0 : n),
                  this.elements.volumetooltip &&
                    (this.elements.volumetooltip.volumeSlider.render(t ? 0 : n),
                    e.toggleClass(
              ...
              onDuration: function (t, n) {
                var i;
                "DVR" === e.adaptiveType(n)
                  ? ((i = "Live"), this.clearCompactMode())
                  : (i = e.timeFormat(n)),
              ...
              checkCompactMode: function (e) {
                -1 === this._maxCompactWidth && this.setCompactModeBounds(),
                  ...
                  -1 !== this._maxCompactWidth &&
                    (e >= this._compactModeMaxSize && e > this._maxCompactWidth
                      ? this._model.set("compactUI", !1)
                      : (e < this._compactModeMaxSize ||
                          e <= this._maxCompactWidth) &&
                        this._model.set("compactUI", !0));
              },
              onCompactUI: function (n, i) {
                e.removeClass(this.el, "jw-drawer-expanded"),
                  this.elements.drawer.setup(this.layout.drawer, i),
                  (!i || this.elements.drawer.activeContents.length < 2) &&
                    t.each(
                      this.layout.drawer,
                      function (e) {
                        this.elements.right.insertBefore(
                          e.el,
                          this.elements.drawer.el
                        );
                      },
                      this
                    );
          ...
          return (
            n.extend(r.prototype, {
              ...
              getDockButton: function (e) {
                return t.hasClass(e.target, "jw-dock-button")
                  ? e.target
                  : t.hasClass(e.target, "jw-dock-text")
              ...
              return (
                ...
                (this.setup = function (r) {
                  if (
                    ...
                    u.hide && t.addClass(c, "jw-hide"),
                      ...
                      "top-right" === u.position &&
                        (l.on("change:dock", this.topRight, this),
                ...
                (this.topRight = function (e) {
                  var t = e.get("controls"),
                    ...
                    i =
                      t &&
                      ((n && n.length) || e.get("sharing") || e.get("related"));
                  a(c, { top: i ? "3.5em" : 0 });
                }),
                (this.element = function () {
                  return c;
            ...
            e.extend(r.prototype, {
              ...
              setImage: function (n) {
                ...
                e.isString(n) && (i = 'url("' + n + '")'),
                  t.style(this.el, { backgroundImage: i });
              },
              element: function () {
                return this.el;
              },
        ...
        (r = function (e, t, n, i, r) {
          ...
          return (
            n.extend(o.prototype, {
              ...
              rightClick: function (e) {
                return (
                  ...
                  this.mouseOverContext
                    ? !1
                    : (this.hideMenu(), this.showMenu(e), !1)
                );
              },
              ...
              hideMenu: function () {
                this.mouseOverContext ||
                  (e.removeClass(this.playerElement, "jw-flag-rightclick-open"),
              ...
              lazySetup: function () {
                this.el ||
                  ...
                  (this.elementUI = new i(this.el, { useHover: !0 })
                    .on(
                      "over",
                      function () {
    ...
    function (e, t, n) {
      ...
      (i = [
        ...
        (r = function (e, t, i, r, o, a, s, l, c, u, d, p, f, h, g, m) {
          var v = e.style,
            w = e.bounds,
            y = e.isMobile(),
            j = [
            ...
            b = function (b, E) {
              function k(t) {
                var n = 0,
                  i = E.get("duration"),
                  o = E.get("position");
                "DVR" === e.adaptiveType(i) &&
                  ((n = i), (i = Math.max(o, r.dvrSeekLimit)));
              ...
              function _(e) {
                ...
                return /13|32|37|38|39|40/.test(e.keyCode)
                  ? (e.preventDefault(), !1)
                  : void 0;
              }
              function x() {
                  ...
                  document.body.contains(ue)
                    ? n &&
                      ...
                      ((n === fe && i === he) ||
                        ...
                        We.trigger(t.JWPLAYER_RESIZE, { width: n, height: i })))
              ...
              function O(e) {
                e &&
                  !y &&
                  (e.element().addEventListener("mousemove", N, !1),
                  e.element().addEventListener("mouseout", W, !1));
              }
              function D() {
                (E.get("state") !== o.IDLE &&
                  E.get("state") !== o.COMPLETE &&
                  E.get("state") !== o.PAUSED) ||
                  !E.get("controls") ||
                  b.play({ reason: "interaction" }),
                  Se ? ee() : te();
              }
              function Y(e) {
                e.link
                  ...
                  : E.get("controls") && b.play({ reason: "interaction" });
              }
              function N() {
                clearTimeout(Te);
              }
              ...
              function J(t, n) {
                n
                  ? (Le && Le.destroy(),
                    e.addClass(ue, "jw-flag-flash-blocked"))
                  : (Le && Le.setup(E, ue, ue),
              ...
              function B() {
                ...
                n.addEventListener("mousemove", te),
                  (we = new s(E, pe, { useHover: !0 })),
                  we.on("click", function () {
                    F({ type: t.JWPLAYER_DISPLAY_CLICK }),
                      E.get("controls") && b.play({ reason: "interaction" });
                  }),
                  we.on("tap", function () {
                ...
                i.on("click", function () {
                  ...
                  e.isChrome() &&
                    i.el.addEventListener("mousedown", function () {
                      var e = E.getVideo(),
                ...
                var o = E.get("height");
                y && ("string" == typeof o || o >= 1.5 * Ie)
                  ? e.addClass(ue, "jw-flag-touch")
                  : ((Le = new f()), Le.setup(E, ue, ue)),
                  (me = new d(b, E)),
              ...
              function U(t) {
                return t.get("state") === o.PAUSED
                  ? void t.once("change:state", U)
                  : void (
                      t.get("scrubbing") === !1 &&
                      e.removeClass(ue, "jw-flag-dragging")
                    );
              }
              function H(t, n) {
              ...
              function z(t, n, i) {
                ...
                (i = !!i),
                  i &&
                    ((o = o.replace(/\s*aspectMode/, "")),
                    ue.className !== o && (ue.className = o),
                    v(ue, { display: "block" }, i)),
                  e.exists(t) &&
                    e.exists(n) &&
              ...
              function q(t, n) {
                ...
                if (i) {
                  ...
                  r && (clearTimeout(Oe), (Oe = setTimeout(q, 250))),
                    ke.resize(),
              ...
              function X() {
                ...
                return Me
                  ? ge.getVideo().getFullScreen()
                  : E.getVideo().getFullScreen();
              }
              function $(e) {
              ...
              function Z(t, n) {
                n
                  ? (e.addClass(t, "jw-flag-fullscreen"),
                    v(document.body, { "overflow-y": "hidden" }),
                    te())
                  : (e.removeClass(t, "jw-flag-fullscreen"),
                    v(document.body, { "overflow-y": "" })),
                  q();
              }
              function ee() {
                (Se = !1),
              ...
              function te() {
                Se ||
                  (e.removeClass(ue, "jw-flag-user-inactive"),
              ...
              function re(t, n) {
                ...
                e.toggleClass(ue, "jw-flag-media-audio", i),
                  i && !o
                    ? ue.insertBefore(ve.el, pe)
                    : ue.insertBefore(ve.el, ke.element());
              }
              function oe(t, n) {
              ...
              function ae(e, t) {
                return t
                  ? void (t.name
                      ? Ee.updateText(t.name, t.message)
                      : Ee.updateText(t.message, ""))
                  : void Ee.playlistItem(e, e.get("playlistItem"));
              }
              function se() {
                var e = E.getVideo();
              ...
              function ce(t, n) {
                if (
                  ((_e = n),
                  clearTimeout(De),
                  n === o.COMPLETE || n === o.IDLE
                    ? (De = setTimeout(le, 100))
                    : le(),
                  se())
                )
              ...
              var ue,
                ...
                Ne = !1,
                We = g.extend(this, i);
              window.webpackJsonpjwplayer && n(309),
                (this.model = E),
                (this.api = b),
                (ue = e.createElement(m({ id: E.get("id") }))),
              ...
              v(ue, {
                ...
                (Ce =
                  ue.requestFullscreen ||
                  ue.webkitRequestFullscreen ||
                  ue.webkitRequestFullScreen ||
                  ue.mozRequestFullScreen ||
                  ue.msRequestFullscreen),
                (Pe =
                ...
                (this.setup = function () {
                  this.handleColorOverrides(),
                    E.get("skin-loading") === !0 &&
                      (e.addClass(ue, "jw-flag-skin-loading"),
              ...
              var Ve = function (t, n) {
                ...
                Be = function (t, n) {
                  var i = E.getVideo();
                  Ye
                    ? (n ? Ce.apply(ue) : Pe.apply(document), Z(ue, n))
                    : e.isIE()
                    ? Z(ue, n)
                    : (ge && ge.getVideo() && ge.getVideo().setFullscreen(n),
                      i.setFullscreen(n)),
                    i &&
                      0 === i.getName().name.indexOf("flash") &&
                      i.setFullscreen(n);
                };
              (this.resize = function (e, t) {
                ...
                (this.destroyInstream = function () {
                  if (
                    ((Me = !1),
                    ge && (ge.off(null, null, this), (ge = null)),
                    this.setAltText(""),
                ...
                (this.getSafeRegion = function (t) {
                  ...
                  return (
                    i &&
                      i.length &&
                      E.get("controls") &&
                      ((n.y = je.element().clientHeight), (n.height -= n.y)),
                    (t = t || !e.exists(t)),
                    t &&
                      E.get("controls") &&
                      (n.height -= me.element().clientHeight),
                    n
                  );
                }),
                (this.destroy = function () {
                  ...
                  E.mediaController &&
                    E.mediaController.off("fullscreenchange", $),
                    ue.removeEventListener("keydown", _, !1),
                    Le && Le.destroy(),
                    ye &&
                      (E.off("change:state", ye.statusDelegate),
                      ye.destroy(),
                      (ye = null)),
    ...
    function (e, t, n) {
      ...
      (i = [
        ...
        (r = function (e, t, n, i, r, o, a, s, l, c, u, d, p, f, h, g, m, v) {
          var w = {};
          return (
            (w.api = e),
            (w._ = t),
            ...
            (w.vid = u),
            (w.events = t.extend({}, d, { state: p })),
            (w.playlist = t.extend({}, f, { item: h })),
            (w.plugins = v),
            (w.cast = g),
            w
          );
    ...
    function (e, t, n) {
      ...
      (i = [n(269), n(48), n(320)]),
        (r = function (e, t, i) {
          ...
          return (
            (e.prototype.setup = function (e, o) {
              e.analytics &&
              ...
              s("casting") &&
                ...
                n.e(4, function (require) {
                  ...
                  (c._castController = new e(c, c._model)),
                    (c.castToggle = c._castController.castToggle.bind(
                      c._castController
                    ));
                });
              var u = i.setup();
    ...
    function (e, t, n) {
      var i, r;
      (i = [n(141), n(48), n(47), n(89), n(1), n(2), n(132), n(274)]),
        (r = function (e, t, i, r, o, a, s, l) {
          function c(e, t, n) {
            if (t) {
              var i = t.client;
          ...
          function u(e, n) {
            ...
            if (
              (a("ads") &&
                ...
                (u.test(p.client)
                  ? (i[p.client] = p)
                  : l.test(p.client) && (i[d + p.client + ".js"] = p),
                delete p.client),
              a("jwpsrv"))
            ) {
            ...
            i.updateProviders(),
              "invalid" === c
                ? l.error(
                    t,
                    "Error setting up player",
                    (void 0 === r ? "Missing" : "Invalid") + " license key"
                  )
                : t();
          }
          function p(e, t) {
          ...
          function f() {
            ...
            return (
              ...
              (e.CHECK_KEY = { method: d, depends: ["LOADED_POLYFILLS"] }),
            ...
            t.extend(r.prototype, e.prototype, {
              buildArray: function () {
                var t = e.prototype.buildArray.apply(this, arguments),
                  ...
                  o =
                    "https://jwplayer.com/learn-more/?m=h&e=" +
                    (i[r] || r) +
                    "&v=" +
                    n;
