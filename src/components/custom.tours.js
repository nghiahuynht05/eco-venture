...
function CustomTours({}) {
  ...
  console.log("background[0]",background[0])
  return (
          ...
          <div className="heading sub-heading">
            <p style={{ textAlign: "center" }}>
              <span id="docs-internal-guid-2678d0d8-7fff-665e-e92e-8766e130d4dd">
                <span>
                  Khi mùa đẹp nhất cham ngõ, K'Lang Adventure mang đến những
                  tour trải nghiệm độc nhất, vào nơi chưa từng được biết đến
                  trên bản đồ du lịch thế giới - Nơi sẽ để lại trong bạn ấn
